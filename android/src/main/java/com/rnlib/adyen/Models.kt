...
data class AppServiceConfigData(var environment:String="",var base_url:String="",var app_url_headers : Map<String, String> = HashMap<String,String>(),var card_public_key : String="", var customApi: Boolean=false)